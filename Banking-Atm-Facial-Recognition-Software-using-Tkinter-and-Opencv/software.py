...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="Face Pay",bg="#deeffe",fg="#000",font=("arial",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#0019fc",width=900,height=500)
        root.geometry("800x500")
        self.button1 = Button(self.frame,text="Click to begin transactions",bg="#deeffe",fg="#000",font=ARIAL,command = self.begin_page)
    ...
    def begin_page(self):
        self.frame.destroy()
        self.frame = Frame(self.root,bg="#deeffe",width=900,height=500)
        root.geometry("800x500")
    ...
    def enroll_user(self):
        ...
        self.plabel = Label(self.frame, text="Password",bg="#deeffe",fg="white",font=ARIAL)
    ...
    def video_capture_page(self):
        ...
        self.frame = Frame(self.root,bg="#deeffe",width=900,height=500)
        #Login Page Form Components
        self.label1 =Label(self.frame,text="Note:",bg="#deeffe",fg="white",font=ARIAL)
